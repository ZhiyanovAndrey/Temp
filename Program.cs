...
// c ref 4 5
// без ref 4 2, если структура то 4,3
...
Firm.ChangeINN(f); // передаем тип со значением 3, изменяет его на 2 при выходе из метода почему???,
...
public struct Firm
{
    ...
    public static void ChangeINN(Firm firm)  // сдесь создается Ссылка 2
    {
